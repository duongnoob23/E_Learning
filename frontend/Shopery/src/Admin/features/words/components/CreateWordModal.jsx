...
import { useCreateWord } from "../hooks/useWordsAdminMutations";
...
export default function CreateWordModal({ onClose, onSuccess, topics = [], defaultTopicId = null }) {
  ...
  const handleSubmit = (e) => {
    ...
    createWordMutation.mutate(formData, {
      onSuccess: (data) => {
      ...
      <div className="word-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <form className="word-modal__form" onSubmit={handleSubmit}>
          ...
          <div className="word-modal__actions">
            ...
            <button type="submit" className="word-modal__btn word-modal__btn--primary" disabled={createWordMutation.isPending}>
