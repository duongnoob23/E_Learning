...
const instructorData = [
  {
    ...
    about:
      "Với hơn 8 năm kinh nghiệm trong lĩnh vực giảng dạy tiếng Anh, tôi đã giúp hàng nghìn học viên đạt được mục tiêu TOEIC của mình. Phương pháp giảng dạy của tôi tập trung vào việc xây dựng nền tảng vững chắc và phát triển kỹ năng thực tế.",
    courses: [
      {
        id: 1,
  ...
  },
  {
    ...
    about:
      "Chuyên gia TOEIC với 6 năm kinh nghiệm, tôi đã phát triển phương pháp học tập hiệu quả giúp học viên cải thiện điểm số một cách nhanh chóng. Tôi tin rằng việc học tiếng Anh phải thú vị và thực tế.",
    courses: [
      {
        id: 3,
  ...
  },
  {
    ...
    about:
      "Với 10 năm kinh nghiệm giảng dạy IELTS, tôi đã giúp hơn 1500 học viên đạt được band điểm mong muốn. Chuyên môn của tôi là IELTS Speaking và Writing, với phương pháp giảng dạy cá nhân hóa và hiệu quả.",
    courses: [
      {
        id: 4,
  ...
  },
  {
    ...
    about:
      "Chuyên gia giao tiếp tiếng Anh với 5 năm kinh nghiệm, tôi tập trung vào việc giúp học viên tự tin trong giao tiếp hàng ngày. Phương pháp của tôi kết hợp lý thuyết và thực hành để đạt hiệu quả tối đa.",
    courses: [
      {
        id: 6,
  ...
  },
  {
    ...
    about:
      "Chuyên gia ngữ pháp tiếng Anh với 7 năm kinh nghiệm, tôi đã phát triển phương pháp học ngữ pháp dễ hiểu và thú vị. Tôi tin rằng ngữ pháp là nền tảng quan trọng để học tiếng Anh hiệu quả.",
    courses: [
      {
        id: 7,
  ...
  },
  {
    ...
    about:
      "Chuyên gia tiếng Anh học thuật với 8 năm kinh nghiệm, tôi đã giúp hàng trăm học viên đạt được mục tiêu du học và làm việc quốc tế. Chuyên môn của tôi là IELTS Reading và Academic Writing.",
    courses: [
      {
        id: 8,
  ...
  },
  {
    ...
    about:
      "Chuyên gia giao tiếp tiếng Anh với 4 năm kinh nghiệm, tôi tập trung vào việc giúp học viên tự tin trong các tình huống giao tiếp hàng ngày. Phương pháp của tôi thực tế và dễ áp dụng.",
    courses: [
      {
        id: 9,
  ...
  },
  {
    ...
    about:
      "Chuyên gia TOEIC với 7 năm kinh nghiệm, tôi đã phát triển các chiến lược hiệu quả giúp học viên đạt điểm cao trong thời gian ngắn. Chuyên môn của tôi là test-taking strategies và time management.",
    courses: [
      {
        id: 10,
  ...
  },
  {
    ...
    about:
      "Chuyên gia IELTS Writing với 9 năm kinh nghiệm, tôi đã giúp hơn 1100 học viên cải thiện kỹ năng viết và đạt band điểm mong muốn. Phương pháp của tôi tập trung vào cấu trúc bài viết và từ vựng học thuật.",
    courses: [
      {
        id: 11,
...
const categories = [
  { id: "all", name: "All Mentors", count: instructorData.length },
  {
    id: "TOEIC",
    name: "TOEIC",
    count: instructorData.filter((i) => i.category === "TOEIC").length,
  },
  {
    id: "IELTS",
    name: "IELTS",
    count: instructorData.filter((i) => i.category === "IELTS").length,
  },
  {
    id: "Basic English",
    name: "Basic English",
    count: instructorData.filter((i) => i.category === "Basic English").length,
  },
];
...
const Instructor = () => {
  ...
  const filteredInstructors = useMemo(() => {
    ...
    return instructorData.filter(
      (instructor) => instructor.category === selectedCategory
    );
  }, [selectedCategory]);
        ...
        <section className="instructor-hero">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p>
                Discover our expert instructors who will guide you on your
                learning journey
              </p>
            </div>
                        ...
                        {[...Array(5)].map((_, i) => (
                          <i
                            ...
                            className={`fa fa-star ${
                              i < Math.floor(instructor.rating) ? "filled" : ""
                            }`}
                          ></i>
                        ))}
                      </div>
