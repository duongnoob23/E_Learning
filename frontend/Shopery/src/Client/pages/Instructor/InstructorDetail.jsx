...
const instructorData = [
  ...
  },
  {
    ...
    about:
      "Chuyên gia TOEIC với 6 năm kinh nghiệm, tôi đã phát triển phương pháp học tập hiệu quả giúp học viên cải thiện điểm số một cách nhanh chóng. Tôi tin rằng việc học tiếng Anh phải thú vị và thực tế. Với background về ngôn ngữ học và kinh nghiệm giảng dạy tại nhiều trung tâm lớn, tôi hiểu rõ cách tiếp cận phù hợp với từng đối tượng học viên.",
    courses: [
      {
        id: 7,
        title: "TOEIC Speaking & Writing: Kỹ Năng Thực Hành",
  ...
  },
  {
    ...
    about:
      "Với 10 năm kinh nghiệm giảng dạy IELTS, tôi đã giúp hơn 1500 học viên đạt được band điểm mong muốn. Chuyên môn của tôi là IELTS Speaking và Writing, với phương pháp giảng dạy cá nhân hóa và hiệu quả. Tôi từng là giám khảo IELTS và hiểu rõ tiêu chí chấm điểm, giúp học viên đạt được kết quả tốt nhất.",
    courses: [
      {
        id: 10,
  ...
  },
  {
    ...
    about:
      "Chuyên gia giao tiếp tiếng Anh với 5 năm kinh nghiệm, tôi tập trung vào việc giúp học viên tự tin trong giao tiếp hàng ngày. Phương pháp của tôi kết hợp lý thuyết và thực hành để đạt hiệu quả tối đa. Tôi tin rằng giao tiếp tự tin là chìa khóa để thành công trong học tập và công việc.",
    courses: [
      {
        id: 14,
  ...
  },
  {
    ...
    about:
      "Chuyên gia ngữ pháp tiếng Anh với 7 năm kinh nghiệm, tôi đã phát triển phương pháp học ngữ pháp dễ hiểu và thú vị. Tôi tin rằng ngữ pháp là nền tảng quan trọng để học tiếng Anh hiệu quả. Với cách tiếp cận thực tế và dễ hiểu, tôi giúp học viên nắm vững ngữ pháp một cách tự nhiên.",
    courses: [
      {
        id: 16,
  ...
  },
  {
    ...
    about:
      "Chuyên gia giao tiếp tiếng Anh với 4 năm kinh nghiệm, tôi tập trung vào việc giúp học viên tự tin trong các tình huống giao tiếp hàng ngày. Phương pháp của tôi thực tế và dễ áp dụng. Tôi tin rằng việc thực hành giao tiếp thường xuyên là cách tốt nhất để cải thiện kỹ năng tiếng Anh.",
    courses: [
      {
        id: 22,
  ...
  },
  {
    ...
    about:
      "Chuyên gia TOEIC với 7 năm kinh nghiệm, tôi đã phát triển các chiến lược hiệu quả giúp học viên đạt điểm cao trong thời gian ngắn. Chuyên môn của tôi là test-taking strategies và time management. Với kinh nghiệm làm giám khảo TOEIC, tôi hiểu rõ cách thức ra đề và cách tối ưu hóa điểm số.",
    courses: [
      {
        id: 24,
        title: "TOEIC Test Strategies: Chiến Lược Làm Bài Hiệu Quả",
    ...
    <div className="instructor-detail-page">
      <div className="instructor-container">
        ...
        <div className="breadcrumb">
          ...
          <Link to="/instructor" className="breadcrumb-link">
            Instructor
          </Link>
        </div>
