...
import "../AssessmentCSS/AssessmentPartSelector.css";
...
const AssessmentPartSelector = () => {
  return (
    <div className="assessment-part">
      {partList.map((part) => (
        <div key={part.id} className="assessment-part__section">
          <label className="assessment-part__header">
            <input type="checkbox" className="assessment-part__checkbox" />
            <span className="assessment-part__title">
              {part.title} ({part.count} câu hỏi)
            </span>
          </label>
      ...
      <div className="assessment-part__actions">
        <button className="assessment-part__start-btn">
          🎯 Bắt đầu luyện tập
        </button>
      </div>
    </div>
...
export default AssessmentPartSelector;
