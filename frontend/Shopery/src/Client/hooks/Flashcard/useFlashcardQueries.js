...
export const flashcardKeys = {
  ...
  userTopics: (params) => [...flashcardKeys.all, 'userTopics', params],
  topicDetail: (topicId) => [...flashcardKeys.all, 'topicDetail', topicId],
  wordsByTopic: (topicId, params) => [...flashcardKeys.all, 'wordsByTopic', topicId, params],
};
...
export const useUserTopics = (params = {}) => {
  return useQuery({
    queryKey: flashcardKeys.userTopics(params),
    queryFn: async () => {
...
export const useUpdateTopic = () => {
  ...
  return useMutation({
    mutationFn: ({ topicId, topicData }) => flashcardApi.updateTopic(topicId, topicData),
...
export const useWordsByTopic = (topicId, params = {}) => {
  return useQuery({
    queryKey: flashcardKeys.wordsByTopic(topicId, params),
...
export const useAddWordToTopic = () => {
  ...
  return useMutation({
    mutationFn: ({ topicId, wordData }) => flashcardApi.addWordToTopic(topicId, wordData),
    onSuccess: (data, variables) => {
      // Invalidate words query để refresh danh sách từ
      queryClient.invalidateQueries({ 
        queryKey: flashcardKeys.wordsByTopic(variables.topicId),
        exact: false 
      });
