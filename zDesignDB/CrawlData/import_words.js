      ...
      try {
        ...
        const [updateResult] = await conn.execute(
          ...
          [
            ...
            w.image_url || null,
            w.audio || null,
            w.definition || null, // Lưu definition vào notes nếu có
            toMySQLDateTime(w.updated_at) ||
        ...
        const [insertResult] = await conn.execute(
          `INSERT INTO words
                        (topic_id, word, part_of_speech, pronunciation, meaning_vi,
                         example_en, example_vi, image_url, audio_url, notes,
